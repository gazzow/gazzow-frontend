...
export default function ProposalCard({
  ...
  return (
    <div className="bg-secondary/30 border border-gray-800 rounded-xl p-5 shadow-lg backdrop-blur-md transition-all hover:shadow-xl hover:border-gray-700">
      {/* Header */}
      ...
      {/* Divider */}
      <div className="border-b border-gray-800/50 my-3" />
      ...
      <div className="grid grid-cols-2 gap-4 text-sm text-gray-400">
        ...
        <div className="flex items-center gap-2 col-span-2">
          ...
          <span className="truncate">
            Proposal: <span className="text-gray-300">{proposal || "—"}</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 col-span-2">
          ...
          <p>
            Expected Rate:{" "}
            <span className="text-gray-300">${expectedRate} / hr</span>
          </p>
        </div>
      </div>
        ...
        <div className="flex gap-2">
          {projectId.id && (
            <Link
              ...
              className="text-sm px-2 py-1 rounded-md border border-gray-700 hover:border-gray-500 bg-secondary/20 text-gray-200 transition"
            >
              View
            </Link>
          )}
